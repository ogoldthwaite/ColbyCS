...
def collision_rotatingBlock_ball(rotatingBlock, ball, dt):
    return collision_ball_rotating_block(ball, rotatingBlock, dt)
...
collision_router[ ('rotating block', 'ball') ] = collision_ball_rotating_block


def collision(a, b, dt = 0.01):
