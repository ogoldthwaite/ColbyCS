...
public class WordCountThread implements Runnable //Each instance of this class is a thread analysing a section of text
{
	...
	private WordCounter<String, Integer> wc; //wordcounter instance for this specific thread
	
	public WordCountThread(int id, String fileName)
	{
		this.id = id;
		this.fileName = fileName;
		wc = new WordCounter<String, Integer>();
	}
